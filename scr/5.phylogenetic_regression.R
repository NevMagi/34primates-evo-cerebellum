...
pic.ROC <- pic.orhto(ROC, tree, intra=TRUE) ## Ibidem.
...
plot(mod1)
plot(phenoMedian$MedianCerebellum ~ phenoMedian$MedianCerebrum, xlab = "Cerebral volume (log-transformed)", ylab = "Cerebellar volume (log-transformed)")
abline(mod1)
...
plot(mod2)
plot(phenoMedianAA$MedianCerebellum ~ phenoMedianAA$MedianCerebrum, xlab = "Cerebral volume (log-transformed)", ylab = "Cerebellar volume (log-transformed)")
abline(mod2)
...
plot(mod3)
plot(phenoMedianAA$MedianCrus ~ phenoMedianAA$MedianCerebellum, xlab = "Cerebellar volume (log-transformed)", ylab = "Ansiform area volume (log-transformed)")
abline(mod3)
...
plot(mod3a)
plot(phenoMedianAA$MedianCrus ~ phenoMedianAA$MedianROC, xlab = "Rest of cerebellar volume (log-transformed)", ylab = "Ansiform area volume (log-transformed)")
abline(mod3a)
...
plot(mod4)
plot(phenoMedianAA$MedianCrus ~ phenoMedianAA$MedianCerebrum,  xlab = "Cerebral volume (log-transformed)", ylab = "Ansiform area volume (log-transformed)")
abline(mod4)
...
ggplotRegression(reg.mod1, ylabel = "Median cerebellar volume (log-transformed)", xlabel = "Median cerebral volume (log-transformed)") + theme_classic()  +
...
ggplotRegression(reg.mod2, ylabel = "Median cerebellar volume (log-transformed)", xlabel = "Median cerebral volume (log-transformed)") + theme_classic()  +
  theme(axis.text=element_text(size=14),
        axis.title=element_text(size=16))
graphics.off()

tiff("./5.phylogenetic_regressions/5.17.regularRegression-ansiformCerebellum.tiff", width = 8, height = 8, units = 'in', res = 300)
ggplotRegression(reg.mod3, ylabel = "Median ansiform area volume (log-transformed)", xlabel = "Median cerebellar volume (log-transformed)") + theme_classic()  +
  theme(axis.text=element_text(size=14),
        axis.title=element_text(size=16))
graphics.off()

tiff("./5.phylogenetic_regressions/5.17a.regularRegression-ansiformROC.tiff", width = 8, height = 8, units = 'in', res = 300)
ggplotRegression(reg.mod3a, ylabel = "Median ansiform area volume (log-transformed)", xlabel = "Median rest of cerebellar volume (log-transformed)") + theme_classic()  +
  theme(axis.text=element_text(size=14),
        axis.title=element_text(size=16))
graphics.off()
...
ggplotRegression(reg.mod4, ylabel = "Median ansiform area volume (log-transformed)", xlabel = "Median cerebral volume (log-transformed)") + theme_classic()  +
  theme(axis.text=element_text(size=14),
        axis.title=element_text(size=16))
graphics.off()
